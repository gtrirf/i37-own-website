  ...
  <footer class="footer">
    <div class="container footer__inner">
      <p class="footer__copy">
        &copy; {{ currentYear }} Islombek Ravshanov. All rights reserved.
      </p>
      ...
      <nav class="footer__social" aria-label="Social links">
        <a
          ...
          :aria-label="getPlatformLabel(link.app)"
          class="footer__social-link"
        >
          <component :is="getSocialIcon(link.app)" />
        </a>
      </nav>
    </div>
  </footer>
...
import { getSocialLinks } from '@/api/index.js'
...
const icons = {
  telegram: defineComponent({
    render: () => h('svg', { viewBox: '0 0 24 24', fill: 'currentColor', 'aria-hidden': 'true' }, [
  ...
  x: defineComponent({
    render: () => h('svg', { viewBox: '0 0 24 24', fill: 'currentColor', 'aria-hidden': 'true' }, [
      h('path', { d: 'M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-4.714-6.231-5.401 6.231H2.746l7.73-8.835L1.254 2.25H8.08l4.258 5.63 5.906-5.63zm-1.161 17.52h1.833L7.084 4.126H5.117z' })
    ])
  }),
...
function getSocialIcon(app) {
  return icons[app] || icons.github
}
</script>
